...
@process_image(image_path="edge_detection_outputs/_log/Log_3x3")#file name to save the image
def main(image):

    #output = sobel(image, ksize=3, dx=1, dy=1, normalize=False, uint8=False, show_result=True)
